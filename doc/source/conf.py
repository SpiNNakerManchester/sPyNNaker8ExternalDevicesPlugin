...
intersphinx_mapping = {'spinn_machine':
                       ...
                       'spynnaker':
                           ("http://spynnaker.readthedocs.io/en/latest/",
                            None),
                       'spynnaker8':
                           ("http://spynnaker8.readthedocs.io/en/latest/",
                            None),
...
project = u'sPyNNaker8ExternalDevicesPlugin'
...
htmlhelp_basename = 'sPyNNaker8ExternalDevicesPlugindoc'
...
latex_documents = [
  ('index', 'sPyNNaker8ExternalDevicesPlugin.tex',
   u'sPyNNaker8ExternalDevicesPlugin Documentation', u'', 'manual'),
]
...
man_pages = [
    ('index', 'sPyNNaker8ExternalDevicesPlugin',
     u'sPyNNaker8ExternalDevicesPlugin Documentation',
     [u''], 1)
]
...
texinfo_documents = [
  ('index', 'sPyNNaker8ExternalDevicesPlugin',
   u'sPyNNaker8ExternalDevicesPlugin Documentation', u'',
   'sPyNNaker8ExternalDevicesPlugin', '', 'Miscellaneous'),
]
...
epub_title = u'sPyNNaker8ExternalDevicesPlugin'
epub_author = u''
epub_publisher = u''
...
for f in os.listdir("."):
    if (os.path.isfile(f) and f.endswith(
        ...
        os.remove(f)
apidoc.main([None, '-o', ".", "../../spynnaker8_external_devices_plugin"])
